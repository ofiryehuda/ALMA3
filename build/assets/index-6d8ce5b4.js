(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function n(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerPolicy&&(a.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?a.credentials="include":r.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(r){if(r.ep)return;r.ep=!0;const a=n(r);fetch(r.href,a)}})();/*! (c) Andrea Giammarchi - ISC */var S={};try{S.WeakMap=WeakMap}catch{S.WeakMap=function(e,n){var s=n.defineProperty,r=n.hasOwnProperty,a=i.prototype;return a.delete=function(l){return this.has(l)&&delete l[this._]},a.get=function(l){return this.has(l)?l[this._]:void 0},a.has=function(l){return r.call(l,this._)},a.set=function(l,o){return s(l,this._,{configurable:!0,value:o}),this},i;function i(l){s(this,"_",{value:"_@ungap/weakmap"+e++}),l&&l.forEach(c,this)}function c(l){this.set(l[0],l[1])}}(Math.random(),Object)}const N=S.WeakMap;/*! (c) Andrea Giammarchi - ISC */var m="-"+Math.random().toFixed(6)+"%",$=!1;try{(function(t,e,n){return e in t&&(t.innerHTML="<p "+n+'="'+m+'"></p>',t[e].childNodes[0].getAttribute(n)==m)})(document.createElement("template"),"content","tabindex")||(m="_dt: "+m.slice(1,-1)+";",$=!0)}catch{}var Z="<!--"+m+"-->",a1=8,c1=1,o1=3,I=/^(?:plaintext|script|style|textarea|title|xmp)$/i,C1=/^(?:area|base|br|col|embed|hr|img|input|keygen|link|menuitem|meta|param|source|track|wbr)$/i;/*! (c) Andrea Giammarchi - ISC */function f1(t){return t.join(Z).replace(h1,m1).replace(u1,p1)}var B=" \\f\\n\\r\\t",q="[^"+B+`\\/>"'=]+`,O="["+B+"]+"+q,K="<([A-Za-z]+[A-Za-z0-9:._-]*)((?:",X=`(?:\\s*=\\s*(?:'[^']*?'|"[^"]*?"|<[^>]*?>|`+q.replace("\\/","")+"))?)",u1=new RegExp(K+O+X+"+)(["+B+"]*/?>)","g"),h1=new RegExp(K+O+X+"*)(["+B+"]*/>)","g"),v1=new RegExp("("+O+`\\s*=\\s*)(['"]?)`+Z+"\\2","gi");function p1(t,e,n,s){return"<"+e+n.replace(v1,g1)+s}function g1(t,e,n){return e+(n||'"')+m+(n||'"')}function m1(t,e,n){return C1.test(e)?t:"<"+e+n+"></"+e+">"}const{isArray:z}=Array,{indexOf:c2,slice:T}=[],V=t=>({get:e=>t.get(e),set:(e,n)=>(t.set(e,n),n)}),w1=1,Y=111,d1=({firstChild:t,lastChild:e})=>{const n=document.createRange();return n.setStartAfter(t),n.setEndAfter(e),n.deleteContents(),t},M=(t,e)=>t.nodeType===Y?1/e<0?e?d1(t):t.lastChild:e?t.valueOf():t.firstChild:t,b1=t=>{const{childNodes:e}=t,{length:n}=e;if(n<2)return n?e[0]:t;const s=T.call(e,0),r=s[0],a=s[n-1];return{ELEMENT_NODE:w1,nodeType:Y,firstChild:r,lastChild:a,valueOf(){if(e.length!==n){let i=0;for(;i<n;)t.appendChild(s[i++])}return t}}};/*! (c) Andrea Giammarchi - ISC */var J=function(t){var e="fragment",n="template",s="content"in i(n),r=s?function(l){var o=i(n);return o.innerHTML=l,o.content}:function(l){var o=i(e),C=i(n),u=null;if(/^[^\S]*?<(col(?:group)?|t(?:head|body|foot|r|d|h))/i.test(l)){var h=RegExp.$1;C.innerHTML="<table>"+l+"</table>",u=C.querySelectorAll(h)}else C.innerHTML=l,u=C.childNodes;return a(o,u),o};return function(o,C){return(C==="svg"?c:r)(o)};function a(l,o){for(var C=o.length;C--;)l.appendChild(o[0])}function i(l){return l===e?t.createDocumentFragment():t.createElementNS("http://www.w3.org/1999/xhtml",l)}function c(l){var o=i(e),C=i("div");return C.innerHTML='<svg xmlns="http://www.w3.org/2000/svg">'+l+"</svg>",a(o,C.firstChild.childNodes),o}}(document);const k=(t,e,n,s,r)=>{const a=n.length;let i=e.length,c=a,l=0,o=0,C=null;for(;l<i||o<c;)if(i===l){const u=c<a?o?s(n[o-1],-0).nextSibling:s(n[c-o],0):r;for(;o<c;)t.insertBefore(s(n[o++],1),u)}else if(c===o)for(;l<i;)(!C||!C.has(e[l]))&&t.removeChild(s(e[l],-1)),l++;else if(e[l]===n[o])l++,o++;else if(e[i-1]===n[c-1])i--,c--;else if(e[l]===n[c-1]&&n[o]===e[i-1]){const u=s(e[--i],-1).nextSibling;t.insertBefore(s(n[o++],1),s(e[l++],-1).nextSibling),t.insertBefore(s(n[--c],1),u),e[i]=n[c]}else{if(!C){C=new Map;let u=o;for(;u<c;)C.set(n[u],u++)}if(C.has(e[l])){const u=C.get(e[l]);if(o<u&&u<c){let h=l,p=1;for(;++h<i&&h<c&&C.get(e[h])===u+p;)p++;if(p>u-o){const v=s(e[l],0);for(;o<u;)t.insertBefore(s(n[o++],1),v)}else t.replaceChild(s(n[o++],1),s(e[l++],-1))}else l++}else t.removeChild(s(e[l++],-1))}return n};/*! (c) Andrea Giammarchi - ISC */var x1=function(t,e,n,s,r){var a=r in t,i=t.createDocumentFragment();i[e](t[s]("g")),i[e](t[s](""));var c=a?t[r](i,!0):i[n](!0);return c.childNodes.length<2?function l(o,C){for(var u=o[n](),h=o.childNodes||[],p=h.length,v=0;C&&v<p;v++)u[e](l(h[v],C));return u}:a?t[r]:function(l,o){return l[n](!!o)}}(document,"appendChild","cloneNode","createTextNode","importNode"),Q="".trim||function(){return String(this).replace(/^\s+|\s+/g,"")},y1=$?function(t,e){var n=e.join(" ");return e.slice.call(t,0).sort(function(s,r){return n.indexOf(s.name)<=n.indexOf(r.name)?-1:1})}:function(t,e){return e.slice.call(t,0)};function M1(t,e){for(var n=e.length,s=0;s<n;)t=t.childNodes[e[s++]];return t}function t1(t,e,n,s){for(var r=t.childNodes,a=r.length,i=0;i<a;){var c=r[i];switch(c.nodeType){case c1:var l=s.concat(i);k1(c,e,n,l),t1(c,e,n,l);break;case a1:var o=c.textContent;if(o===m)n.shift(),e.push(I.test(t.nodeName)?G(t,s):T1(c,s.concat(i)));else switch(o.slice(0,2)){case"/*":if(o.slice(-2)!=="*/")break;case"👻":t.removeChild(c),i--,a--}break;case o1:I.test(t.nodeName)&&Q.call(c.textContent)===Z&&(n.shift(),e.push(G(t,s)));break}i++}}function k1(t,e,n,s){for(var r=t.attributes,a=[],i=[],c=y1(r,n),l=c.length,o=0;o<l;){var C=c[o++],u=C.value===m,h;if(u||1<(h=C.value.split(Z)).length){var p=C.name;if(a.indexOf(p)<0){a.push(p);var v=n.shift().replace(u?/^(?:|[\S\s]*?\s)(\S+?)\s*=\s*('|")?$/:new RegExp("^(?:|[\\S\\s]*?\\s)("+p+`)\\s*=\\s*('|")[\\S\\s]*`,"i"),"$1"),d=r[v]||r[v.toLowerCase()];if(u)e.push(P(d,s,v,null));else{for(var b=h.length-2;b--;)n.shift();e.push(P(d,s,v,h))}}i.push(C)}}l=i.length,o=0;for(var E=0<l&&$&&!("ownerSVGElement"in t);o<l;){var w=i[o++];E&&(w.value=""),t.removeAttribute(w.name)}var x=t.nodeName;if(/^script$/i.test(x)){var y=document.createElement(x);for(l=r.length,o=0;o<l;)y.setAttributeNode(r[o++].cloneNode(!0));y.textContent=t.textContent,t.parentNode.replaceChild(y,t)}}function T1(t,e){return{type:"any",node:t,path:e}}function P(t,e,n,s){return{type:"attr",node:t,path:e,name:n,sparse:s}}function G(t,e){return{type:"text",node:t,path:e}}var j=V(new N);function L1(t,e){var n=(t.convert||f1)(e),s=t.transform;s&&(n=s(n));var r=J(n,t.type);e1(r);var a=[];return t1(r,a,e.slice(0),[]),{content:r,updates:function(i){for(var c=[],l=a.length,o=0,C=0;o<l;){var u=a[o++],h=M1(i,u.path);switch(u.type){case"any":c.push({fn:t.any(h,[]),sparse:!1});break;case"attr":var p=u.sparse,v=t.attribute(h,u.name,u.node);p===null?c.push({fn:v,sparse:!1}):(C+=p.length-2,c.push({fn:v,sparse:!0,values:p}));break;case"text":c.push({fn:t.text(h),sparse:!1}),h.textContent="";break}}return l+=C,function(){var d=arguments.length;if(l!==d-1)throw new Error(d-1+" values instead of "+l+`
`+e.join("${value}"));for(var b=1,E=1;b<d;){var w=c[b-E];if(w.sparse){var x=w.values,y=x[0],D=1,_=x.length;for(E+=_-2;D<_;)y+=arguments[b++]+x[D++];w.fn(y)}else w.fn(arguments[b++])}return i}}}}function E1(t,e){var n=j.get(e)||j.set(e,L1(t,e));return n.updates(x1.call(document,n.content,!0))}var z1=[];function H1(t){var e=z1,n=e1;return function(s){return e!==s&&(n=E1(t,e=s)),n.apply(null,arguments)}}function e1(t){for(var e=t.childNodes,n=e.length;n--;){var s=e[n];s.nodeType!==1&&Q.call(s.textContent).length===0&&t.removeChild(s)}}/*! (c) Andrea Giammarchi - ISC */var Z1=function(){var t=/acit|ex(?:s|g|n|p|$)|rph|ows|mnc|ntw|ine[ch]|zoo|^ord/i,e=/([^A-Z])([A-Z]+)/g;return function(c,l){return"ownerSVGElement"in c?s(c,l):a(c.style,!1)};function n(i,c,l){return c+"-"+l.toLowerCase()}function s(i,c){var l;return c?l=c.cloneNode(!0):(i.setAttribute("style","--hyper:style;"),l=i.getAttributeNode("style")),l.value="",i.setAttributeNode(l),a(l,!0)}function r(i){var c,l=[];for(c in i)l.push(c.replace(e,n),":",i[c],";");return l.join("")}function a(i,c){var l,o;return function(C){var u,h,p,v;switch(typeof C){case"object":if(C){if(l==="object"){if(!c&&o!==C)for(h in o)h in C||(i[h]="")}else c?i.value="":i.cssText="";u=c?{}:i;for(h in C)v=C[h],p=typeof v=="number"&&!t.test(h)?v+"px":v,!c&&/^--/.test(h)?u.setProperty(h,p):u[h]=p;l="object",c?i.value=r(o=u):o=C;break}default:o!=C&&(l="string",o=C,c?i.value=C||"":i.cssText=C||"");break}}}}();const B1=t=>e=>{for(const n in e){const s=n==="role"?n:`aria-${n}`,r=e[n];r==null?t.removeAttribute(s):t.setAttribute(s,r)}},F=(t,e)=>{let n,s=!0;const r=document.createAttributeNS(null,e);return a=>{n!==a&&(n=a,n==null?s||(t.removeAttributeNode(r),s=!0):(r.value=a,s&&(t.setAttributeNodeNS(r),s=!1)))}},A1=(t,e,n)=>s=>{n!==!!s&&((n=!!s)?t.setAttribute(e,""):t.removeAttribute(e))},n1=({dataset:t})=>e=>{for(const n in e){const s=e[n];s==null?delete t[n]:t[n]=s}},S1=(t,e)=>{let n,s=e.slice(2);return!(e in t)&&e.toLowerCase()in t&&(s=s.toLowerCase()),r=>{const a=z(r)?r:[r,!1];n!==a[0]&&(n&&t.removeEventListener(s,n,a[1]),(n=a[0])&&t.addEventListener(s,n,a[1]))}},N1=t=>e=>{typeof e=="function"?e(t):e.current=t},R=(t,e)=>e==="dataset"?n1(t):n=>{t[e]=n},$1=(t,e)=>{let n;return s=>{n!==s&&(n=s,t[e]!==s&&(s==null?(t[e]="",t.removeAttribute(e)):t[e]=s))}},O1=/^(?:form|list)$/i,V1=(t,e)=>t.ownerDocument.createTextNode(e);function s1(t){return this.type=t,H1(this)}s1.prototype={attribute(t,e,n){const s=this.type==="svg";switch(e){case"class":if(s)return F(t,e);e="className";case"props":return R(t,e);case"aria":return B1(t);case"style":return Z1(t,n,s);case"ref":return N1(t);case".dataset":return n1(t);default:return e.slice(0,1)==="."?R(t,e.slice(1)):e.slice(0,1)==="?"?A1(t,e.slice(1)):e.slice(0,2)==="on"?S1(t,e):e in t&&!(s||O1.test(e))?$1(t,e):F(t,e)}},any(t,e){const{type:n}=this;let s=!1,r;const a=i=>{switch(typeof i){case"string":case"number":case"boolean":s?r!==i&&(r=i,e[0].textContent=i):(s=!0,r=i,e=k(t.parentNode,e,[V1(t,i)],M,t));break;case"function":a(i(t));break;case"object":case"undefined":if(i==null){s=!1,e=k(t.parentNode,e,[],M,t);break}default:if(s=!1,r=i,z(i))if(i.length===0)e.length&&(e=k(t.parentNode,e,[],M,t));else switch(typeof i[0]){case"string":case"number":case"boolean":a(String(i));break;case"function":a(i.map(D1,t));break;case"object":z(i[0])&&(i=i.concat.apply([],i));default:e=k(t.parentNode,e,i,M,t);break}else"ELEMENT_NODE"in i?e=k(t.parentNode,e,i.nodeType===11?T.call(i.childNodes):[i],M,t):"text"in i?a(String(i.text)):"any"in i?a(i.any):"html"in i?e=k(t.parentNode,e,T.call(J([].concat(i.html).join(""),n).childNodes),M,t):"length"in i&&a(T.call(i));break}};return a},text(t){let e;const n=s=>{if(e!==s){e=s;const r=typeof s;r==="object"&&s?"text"in s?n(String(s.text)):"any"in s?n(s.any):"html"in s?n([].concat(s.html).join("")):"length"in s&&n(T.call(s).join("")):r==="function"?n(s(t)):t.textContent=s??""}};return n}};function D1(t){return t(this)}const{create:_1,freeze:I1,keys:o2}=Object,W=V(new N),P1=t=>({html:U("html",t),svg:U("svg",t),render(e,n){const s=typeof n=="function"?n():n,r=W.get(e)||W.set(e,L()),a=s instanceof A?H(t,r,s):s;return a!==r.wire&&(r.wire=a,e.textContent="",e.appendChild(a.valueOf())),e}}),L=()=>({stack:[],entry:null,wire:null}),U=(t,e)=>{const n=V(new N),s=a=>function(){return H(e,a,r.apply(null,arguments))};return r.for=(a,i)=>{const c=n.get(a)||n.set(a,_1(null));return c[i]||(c[i]=s(L()))},r.node=function(){return H(e,L(),r.apply(null,arguments)).valueOf()},r;function r(){return new A(t,j1.apply(null,arguments))}},H=(t,e,{type:n,template:s,values:r})=>{const{length:a}=r;i1(t,e,r,a);let{entry:i}=e;if(!i||i.template!==s||i.type!==n){const c=new t(n);e.entry=i={type:n,template:s,tag:c,wire:b1(c(s,...r))}}else i.tag(s,...r);return i.wire},i1=(t,{stack:e},n,s)=>{for(let r=0;r<s;r++){const a=n[r];a instanceof G1?n[r]=H(t,e[r]||(e[r]=L()),a):z(a)?i1(t,e[r]||(e[r]=L()),a,a.length):e[r]=null}s<e.length&&e.splice(s)};I1(A);function A(t,e){this.type=t,this.template=e.shift(),this.values=e}const G1=A,{render:C2,html:f,svg:f2}=P1(s1);function j1(){let t=[],e=0,{length:n}=arguments;for(;e<n;)t.push(arguments[e++]);return t}const F1="Glitch in Bio!",R1="My meta description.",W1="Glitch in Bio",U1="glitch",q1="https://cdn.glitch.com/560ed5ed-9d00-433a-9ff9-7750d79d13da%2FGlitch_TeamAvatar.png?v=1624643105812",r1=[{url:"https://glitch.new/links",text:"Remix! Have your own Glitch-in-bio running in seconds.",img:"https://cdn.glitch.me/efc5414a-882b-4708-af81-8461abbc1a82%2Fglitchmidblues.png?v=1634289872484",altText:"Glitch blue generative art"},{url:"https://glitch.com/edit/#!/glitch-in-bio?path=README.md",text:"View source! Check out the code to see how it's built.",img:""},{url:"https://www.glitch.com/",text:"Built by and on Glitch, the easiest way to build the web.",img:"https://cdn.glitch.me/efc5414a-882b-4708-af81-8461abbc1a82%2Fglitchdarkpinks.png?v=1634289859236"}],K1={glitch:"https://glitch.com/",arena:"",bandcamp:"",cohost:"",dev:"https://dev.to/glitch",facebook:"",github:"https://github.com/glitchdotcom",gitlab:"",hashnode:"",instagram:"",keybase:"",kofi:"",letterboxd:"",linkedin:"https://www.linkedin.com/company/fog-creek-software",mastodon:"https://mastodon.social/@glitchdotcom",medium:"",onlyfans:"",patreon:"",pinboard:"",pinterest:"",podcast:"",soundcloud:"",spotify:"",stackoverflow:"",substack:"",twitter:"https://twitter.com/glitch",twitch:"",tiktok:"",tumblr:"",youtube:"https://www.youtube.com/c/GlitchDotCom",email:"support@glitch.com"},g={metaTitle:F1,metaDescription:R1,name:W1,theme:U1,avatarImage:q1,links:r1,social:K1},X1=f.node`
...
C213.484,200.108,212.476,198.418,210.857,197.545z"
  ...
  `,r2=document.getElementsByTagName("head")[0];r2.appendChild(X1);const l2=document.getElementById("content"),a2=[Y1,Q1,i2,t2];a2.forEach(t=>l2.appendChild(t));
